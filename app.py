...
os.environ["OPENAI_API_KEY"] = "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"
...
st.set_page_config(
    page_title="Dummy POC Multitenancy",
    page_icon="🦙",
    layout="centered",
...
st.title("Dummy POC Multitenancy")

# Initialize session state for options if not already set
if "options" not in st.session_state:
    st.session_state.options = {"Abhinav": "Abhinav"}
...
with st.sidebar:
    selected_option = st.selectbox("Choose a User:", st.session_state.selectbox_options)
